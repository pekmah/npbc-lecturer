...
const Intake = () => {
  ...
  return (
    <div
      className={
        "bg-c-blue p-4 md:p-6 flex flex-col md:flex-row gap-y-8 text-c-white"
      }
    >
      <div className={"flex-1 flex flex-col gap-4 md:gap-8"}>
        <div className={"flex flex-col gap-4"} data-aos="fade-up-right">
          ...
          <h6 className={"c-medium font-light"}>
        ...
        <div className="flex gap-4 items-center" data-aos="fade-up">
          ...
          <Button
            className={
              "bg-none h-8 text-xs text-[#FFFFFFB2] flex items-center gap-2 font-semibold px-5  justify-center"
            }
          >
            View Courses first
          </Button>
      ...
      <div className={"flex-1"}>
        <img
          className={"h-full object-cover md:ml-6 "}
