  ...
  return (
    <div className={"px-4 py-8 text-c-blue"}>
      ...
      <div className={"flex gap-4 items-center"}>
        {/*    title    */}
        <h6 className={"c-h7"}>Latest News</h6>
      ...
      <div className={"grid grid-cols-1 md:grid-cols-3 gap-6"}>
        {/*main news pane */}
        <div className={"flex flex-col md:row-span-2 md:col-span-2"}>
          {/*    image    */}
          <img
            src="/images/about/news/news-1.jpg"
            alt="news-1"
            className={
              "md:min-h-[500px] object-contain md:object-cover object-center w-full"
            }
          />
          ...
          <a
            href={"/about/news/news_1"}
            className={"text-lg md:c-h7 font-semibold"}
          >
            {" "}
        ...
        <div className={" row-span-1 "}>
          ...
          <a
            href={"/about/news/news_2"}
            className={"text-lg md:c-large leading-7 font-semibold"}
          >
        ...
        <div className={" row-span-1"}>
          ...
          <a
            href={"/about/news/news_3"}
            className={"c-large leading-7 font-semibold"}
          >
