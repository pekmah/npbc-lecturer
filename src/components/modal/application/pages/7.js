...
const Finish = ({ handleCloseModal, switchToPrevious }) => {
  return (
    <div className={"text-c-blue w-full"}>
      ...
      <div
        className={
          " gap-5 md:py-8 border-b border-gray-400 h-[60vh] flex flex-col justify-center items-center"
        }
      >
        {/*    Details section  */}
        <h6 className={"c-large font-bold md:w-2/3 mx-auto text-center "}>
          Thank you for taking your time to apply. We will contact you soon
          regarding your application. Here is a digital signature to sign off
          your declaration.
        </h6>

        <div className={"flex gap-4 md:w-2/3 px-5"}>
          <input type={"checkbox"} />

          <p>
            I declare that the information given herein is true and accurate to
            the best of my knowledge and fully understand that any information
