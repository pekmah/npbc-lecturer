    ...
    return (
        <div className={"flex-1 flex flex-col"}>
            ...
            <div className={"px-3 border-l border-l-gray-400 my-4 flex-1"}>
                ...
                <Button
                    className={"flex justify-between border-b border-gray-300 rounded-none py-2 w-full items-center"}>
                ...
                <Button
                    className={"flex justify-between border-b border-gray-300 rounded-none py-2 w-full items-center mt-2"}>
