...
const Tables = () => {
  return (
    <div
      className={
        "md:flex-[2] text-c-blue flex flex-col gap-4 p-2 md:p-5 border border-gray-300 w-full overflow-x-scroll"
      }
    >
      ...
      <table class="min-w-full text-left text-sm font-light mt-6">
        <thead class="border-b font-semibold dark:border-neutral-500 bg-[#092A5914]">
          <tr>
            <th scope="col" class="px-6 py-4">
              Recipient
