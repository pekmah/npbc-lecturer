...
const UploadForm = () => {
    return (
        <div className={"p-5 border border-gray-300"}>
            ...
            {/*    form     */}
            <form className={"grid grid-cols-2 gap-x-4 gap-y-6 text-c-blue mt-2"} action="">
                <div>
                    {/*    label    */}
                    <h6 className={"font-medium mb-2"}>National ID/Passport</h6>
                    <div className={"border-2 border-dashed border-c-gray flex items-center justify-center h-28 w-full"}>
                ...
                <div>
                    {/*    label    */}
                    <h6 className={"font-medium mb-2"}>High School Certificate / Results</h6>
                    <div className={"border-2 border-dashed border-c-gray flex items-center justify-center h-28 w-full"}>
