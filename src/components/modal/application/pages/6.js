...
const PreviewApplication = ({handleCloseModal, switchToPrevious, switchToNext}) => {
    return (
        <div className={"text-c-blue w-full"}>
            ...
            <div className={"flex"}>
                ...
                <div className={"flex items-center flex-col flex-1 text-center"}>
                    <h4 className={"c-h5 font-bold w-2/3 mx-auto"}>You checked all the boxes. Here’s what you
                        submitted</h4>
                </div>
