                ...
                <div className="flex my-8 flex-1">
                    ...
                    <div className="flex flex-col gap-5">
                        ...
                        <RequirementItem
                            ...
                            desc={"View the main requirements for the general application process including documents to upload, terms and conditions and the application fee"}
                        />

                        <RequirementItem
                            title={"Select Course"}
                            desc={"Choose a study level, certificate, diploma or undergraduate, pick a course among the choices and see the qualifications needed for the choice you made"}
                        />

                        <RequirementItem
                            title={"Enter your details"}
                            desc={"Input correct details under the sections as follows; personal details, contact, next of kin, educational background, verify course, current occupation and finally upload the relevant files"}
                        />

                        <RequirementItem
                            title={"Payment"}
                            desc={"View the payment details and edit where necessary and request for Mpesa payment prompt to proceed"}
                        />

                        <RequirementItem
                            title={"Preview Application & Finish"}
                            desc={"View all the details as you have entered them to ascertain their correctness. Finally confirm your application with a final declaration"}
                        />
                    </div>
                </div>
                ...
                <div className="flex my-6 flex-col gap-8 flex-1">
                    <div className="px-4 py-2 bg-[#FFFFFF14]" data-aos="fade-left">
                        ...
                        <div className="flex justify-between items-center">
                            <span className="text-xs font-light">Gardent Estate Off Thika Road Office</span>
                    ...
                    <div className="px-4 py-2 bg-[#FFFFFF14]" data-aos="fade-left">
                        ...
                        <div className="flex justify-between items-center">
                            <span className="text-xs font-light">NPBC Email : admin@npbc.co.ke</span>
