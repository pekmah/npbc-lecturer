    ...
    <div className='py-16 bg-[#092A5920] flex'>
          ...
          <div className="flex-1">
              <p className='c-medium font-medium text-c-blue px-3'>
                  We have courses for everyone with any level of qualification and educational background  At NPBC, we are committed to providing a high-quality education in biblical studies and ministry training.
