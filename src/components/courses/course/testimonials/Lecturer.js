...
const Lecturer = () => {
    return (
        <div className={"flex gap-4"}>
            <img className={"object-cover flex-[0.8]"} src="/images/courses/course/lecturer-1.jpg" alt="lecturer 1"/>
            ...
            <div className={"text-c-blue flex-1 flex flex-col gap-1"}>
                ...
                <p className={"text-sm font-medium text-[#092A59A8]"}>B.A.Diplomacy & Foreign Affairs</p>
