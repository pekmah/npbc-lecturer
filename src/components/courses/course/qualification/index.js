...
const Qualification = () => {
  return (
    <div className="flex bg-c-blue">
      ...
      <div className="md:w-3/4 text-c-white py-5 px-5 md:px-0 md:py-12">
        ...
        <ul className="py-4 flex flex-col gap-2 px-2">
          <li className="flex gap-2 items-center">
            <AiOutlineCheckCircle className="text-md flex-shrink-0" />
          ...
          <li className="flex gap-2 items-center">
            ...
            <p className="text-md md:text-lg font-medium ">
              ...
              diploma in theology from a recognized institution cation
            </p>
          </li>
          <li className="flex gap-2 items-center">
            <AiOutlineCheckCircle className="text-md flex-shrink-0" />
        ...
        {/* title */}
        <h6 className="text-lg md:text-xl font-semibold mt-2">
        ...
        <ul className="py-4 flex flex-col gap-2 px-2">
          ...
          <li className="flex gap-2 items-center">
            <AiOutlineCheckCircle className="text-lg" />
            <p className="text-md md:text-lg font-medium ">Photo passport</p>
          </li>
          <li className="flex gap-2 items-center">
            <AiOutlineCheckCircle className="text-lg" />
            <p className="text-md md:text-lg font-medium ">passport</p>
          </li>
        </ul>
      </div>
    </div>
