...
const Programs = () => {
  return (
    <section className="text-c-blue bg-c-blue p-2 md:p-5 relative py-8">
      ...
      <div
        id={"undergraduate"}
        className="px-2 md:px-6 py-2 md:py-6 bg-[#FFFFFF14] border border-[#FFFFFF14] my-2"
      >
        {/**Title */}
        <h6 className="text-xl font-semibold text-white mb-3">
        ...
        <div className="flex flex-col md:flex-row md:justify-between gap-y-5">
          <CourseItem
            ...
            desc={
              "Admission into a degree program at Global University will be based on the following minimum requirements"
            }
            link={"courses/babt"}
          />
