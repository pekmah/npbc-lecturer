...
const Footer = ({showModal}) => {
    return (
        ...
        >
            {/* image */}
            <div className="text-center h-48 c-h7 md:c-h3 p-3 flex flex-col gap-5 items-center justify-center"
                 style={{
                     background:
                ...
                <p className='leading-8 md:leading-10 text-white' data-aos="fade-up">Become a student at <br/> NPBC</p>
