      ...
      <div className="flex flex-col md:flex-row">
        ...
        <div className="flex-1">
          <img
            ...
            src="/images/home/admission-1.webp"
            alt="admission"
          />
        </div>
        ...
        <div className="bg-c-red flex-1 py-8 md:py-12 flex flex-col items-center text-white">
          <h2 className="c-h7 md:c-h4  font-semibold" data-aos="fade-up-left">
            Apply for Admission
          </h2>

          <p
            className="c-normal md:c-large mt-2 md:mt-4 font-normal"
            data-aos="fade-up-left"
          >
            {new Date().getFullYear()} Applications are now open
          </p>
          ...
          <div
            className="w-11/12 mx-auto flex md:block justify-center"
            data-aos="fade-up"
          >
            <Button
              className={
                "bg-white mx-auto py-2 md:py-3 px-8 md:px-0 md:w-3/6 text-c-red text-sm md:text-base font-semibold md:font-bold "
              }
