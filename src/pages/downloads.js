    ...
    return (
        <Layout>
            <div className={"relative min-h-[95vh] bg-[#092A5905]"}>
                ...
                <Body>
                    {/*   Program Table     */}
                    <Table title={"Program Pamphlets"} headerList={table_columns} data={program_Data}/>

                    {/*    Admission Form Table     */}
                    <Table title={"Admission Forms"} headerList={table_columns} data={admission_Data}/>

                    {/*    Fees Structure Table     */}
                    <Table title={"Fee Structure"} headerList={fee_table_columns} data={fee_Data}/>
